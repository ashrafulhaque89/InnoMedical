class PrescriptionsController < ApplicationController
  ...
  def create
    @prescription = Prescription.new(prescription_params.merge(:doctor =>current_user.doctor))
  ...
  private
    ...
    def prescription_params
      params.require(:prescription).permit(:medicine_name, :instructions, :prescription_date, :valid_until_date, :patient_profile_id)
    end
end
